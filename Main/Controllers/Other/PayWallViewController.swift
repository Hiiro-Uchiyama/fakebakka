...
class PayWallViewController: UIViewController {
    ...
    // Install the behaviour when the button is pressed.
    ...
    // Sets the behaviour when the close button is pressed.
